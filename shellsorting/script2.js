...
function GetData () {
    'use strict';
    var input = document.getElementsByTagName('input'), dataArray = [], inputValue = [], valueOfNumber, i, len;
...
GetData.prototype.shellSort = function () {
    ...
    function showSortSteps () {
        var len = afterSortArray.length, firstId, secondId, firstIdValue, secondIdValue;
        setTimeout(function () {
